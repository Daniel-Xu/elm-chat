...
var _saschatimme$elm_phoenix$Phoenix_Internal_Channel$channelMap = F2(
	function (func, chan) {
		var f = _elm_lang$core$Maybe$map(
			F2(
				function (x, y) {
...
var _saschatimme$elm_phoenix$Phoenix_Internal_Channel$map = F2(
	function (func, _p11) {
		...
		return A2(
			...
			_p12.state,
			A2(_saschatimme$elm_phoenix$Phoenix_Internal_Channel$channelMap, func, _p12.channel));
	});
var _saschatimme$elm_phoenix$Phoenix_Internal_Channel$updateState = F2(
	function (state, internalChannel) {
		if (internalChannel.channel.debug) {
			var _p13 = function () {
				var _p14 = {ctor: '_Tuple2', _0: state, _1: internalChannel.state};
				_v5_5:
				do {
					if (_p14.ctor === '_Tuple2') {
						switch (_p14._0.ctor) {
							case 'Closed':
								if (_p14._1.ctor === 'Closed') {
									return state;
								} else {
									break _v5_5;
								}
							case 'Joining':
								if (_p14._1.ctor === 'Joining') {
									return state;
								} else {
									break _v5_5;
								}
							case 'Joined':
								if (_p14._1.ctor === 'Joined') {
									return state;
								} else {
									break _v5_5;
								}
							case 'Errored':
								if (_p14._1.ctor === 'Errored') {
									return state;
								} else {
									break _v5_5;
								}
							default:
								if (_p14._1.ctor === 'Disconnected') {
									return state;
								} else {
									break _v5_5;
								}
...
var _saschatimme$elm_phoenix$Phoenix_Internal_Socket$socketMap = F2(
...
var _saschatimme$elm_phoenix$Phoenix_Internal_Socket$isOpening = function (internalSocket) {
	var _p21 = internalSocket.connection;
	if (_p21.ctor === 'Opening') {
		return true;
	} else {
		return false;
	}
...
var _saschatimme$elm_phoenix$Phoenix_Internal_Socket$increaseRef = function (socket) {
	var _p22 = socket.connection;
	if (_p22.ctor === 'Connected') {
		return _elm_lang$core$Native_Utils.update(
			socket,
			{
				connection: A2(_saschatimme$elm_phoenix$Phoenix_Internal_Socket$Connected, _p22._0, _p22._1 + 1)
			});
	} else {
		return socket;
	}
...
var _saschatimme$elm_phoenix$Phoenix_Internal_Socket$resetBackoff = function (connection) {
	var _p23 = connection;
	if (_p23.ctor === 'Opening') {
		return A2(_saschatimme$elm_phoenix$Phoenix_Internal_Socket$Opening, 0, _p23._1);
	} else {
		return connection;
	}
};
var _saschatimme$elm_phoenix$Phoenix_Internal_Socket$update = F2(
	function (nextSocket, _p24) {
		var _p25 = _p24;
		var _p26 = _p25.connection;
		var updatedConnection = (!_elm_lang$core$Native_Utils.eq(nextSocket.params, _p25.socket.params)) ? _saschatimme$elm_phoenix$Phoenix_Internal_Socket$resetBackoff(_p26) : _p26;
...
var _saschatimme$elm_phoenix$Phoenix$subMap = F2(
	function (func, sub) {
		...
		return A2(
			...
			A2(_saschatimme$elm_phoenix$Phoenix_Internal_Socket$socketMap, func, _p29._0),
			A2(
				_elm_lang$core$List$map,
				_saschatimme$elm_phoenix$Phoenix_Internal_Channel$channelMap(func),
				_p29._1));
	});
...
var _user$project$App$messageView = function (message) {
	return A2(
...
var _user$project$App$messagesView = function (messages) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$App$messageView, messages));
};
var _user$project$App$socketUrl = 'ws://localhost:4000/socket/websocket';
var _user$project$App$socket = _saschatimme$elm_phoenix$Phoenix_Socket$init(_user$project$App$socketUrl);
var _user$project$App$Model = F3(
	function (a, b, c) {
		return {messages: a, newMessage: b, state: c};
	});
var _user$project$App$Message = F2(
	function (a, b) {
		return {user: a, body: b};
	});
var _user$project$App$messageDecoder = A3(
		...
		switch (_p0.ctor) {
			...
			case 'SendMsg':
				...
				var push = A2(
					...
					payload,
					A2(_saschatimme$elm_phoenix$Phoenix_Push$init, 'room:lobby', 'new:msg'));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{newMessage: ''}),
					_1: A2(_saschatimme$elm_phoenix$Phoenix$push, _user$project$App$socketUrl, push)
				};
			default:
				var _p1 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$App$messageDecoder, _p0._0);
				if (_p1.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$App$NewMsg = function (a) {
	return {ctor: 'NewMsg', _0: a};
};
var _user$project$App$lobby = _saschatimme$elm_phoenix$Phoenix_Channel$withDebug(
	A3(
		_saschatimme$elm_phoenix$Phoenix_Channel$on,
		'new:msg',
		_user$project$App$NewMsg,
		_saschatimme$elm_phoenix$Phoenix_Channel$init('room:lobby')));
var _user$project$App$subscriptions = function (model) {
	var connect = _saschatimme$elm_phoenix$Phoenix$connect(_user$project$App$socket);
	var _p3 = model.state;
	switch (_p3.ctor) {
		case 'JoinedLobby':
			return connect(
...
var _user$project$App$SendMsg = {ctor: 'SendMsg'};
var _user$project$App$UpdateState = function (a) {
...
var _user$project$App$JoiningLobby = {ctor: 'JoiningLobby'};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _user$project$App$messageView, model.messages)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$App$UpdateState(_user$project$App$JoiningLobby)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onSubmit(_user$project$App$SendMsg),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$App$JoinedLobby = {ctor: 'JoinedLobby'};
var _user$project$App$LeavingLobby = {ctor: 'LeavingLobby'};
var _user$project$App$LeftLobby = {ctor: 'LeftLobby'};
var _user$project$App$init = function (path) {
	return {
		...
		_0: {
			newMessage: '',
			messages: {ctor: '[]'},
			state: _user$project$App$LeftLobby
		},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
